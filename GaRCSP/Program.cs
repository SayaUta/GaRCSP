...
namespace GaRCSP
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             * }*/
            pPrecCons[0].act1 = 1; pPrecCons[0].act2 = 4;
            pPrecCons[1].act1 = 1; pPrecCons[1].act2 = 2;
            pPrecCons[2].act1 = 1; pPrecCons[2].act2 = 3;
            pPrecCons[3].act1 = 4; pPrecCons[3].act2 = 7;
            pPrecCons[4].act1 = 2; pPrecCons[4].act2 = 7;
            pPrecCons[5].act1 = 3; pPrecCons[5].act2 = 5;
            pPrecCons[6].act1 = 3; pPrecCons[6].act2 = 6;
            pPrecCons[7].act1 = 5; pPrecCons[7].act2 = 7;
            pPrecCons[8].act1 = 6; pPrecCons[8].act2 = 7;
            pPrecCons[9].act1 = 7; pPrecCons[9].act2 = 8;
            int maxdur;
